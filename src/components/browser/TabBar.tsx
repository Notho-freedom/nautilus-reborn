import { Plus, X, Globe, Loader2, Pin, Copy, XCircle } from 'lucide-react';
    ...
    <>
        ...
        {tabs.map(tab => {
          ...
          return (
            ...
            >
              ...
              {tab.isPinned && <Pin size={8} className="text-primary" />}
      ...
      {contextMenu && (
        <>
          ...
          <div
            className="fixed z-50 glass rounded-lg border border-border py-1 min-w-[160px] shadow-lg"
          ...
          >
            {[
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-1.5 text-[11px] text-foreground hover:bg-muted/50 transition-colors"
              >
