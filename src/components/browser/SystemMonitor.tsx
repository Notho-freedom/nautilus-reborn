import { Activity, Cpu, MemoryStick, MonitorSpeaker, Wifi, Battery, Thermometer } from 'lucide-react';
...
export function SystemMonitor({ stats, onClose }: SystemMonitorProps) {
  return (
    <SidebarPanelShell title="System Monitor" icon={Activity} onClose={onClose ?? (() => {})}>
